...
// The crosshair itself: a dot at the centre of the aimed picture,
// haloed so it reads on any scene.
void world_reticle(impl::App *a, impl::WorldState &w) {
    ...
    dl->AddCircleFilled(c, 4.0f, ImGui::GetColorU32(ImGuiCol_WindowBg, 0.7f));
    dl->AddCircleFilled(c, 2.5f, ImGui::GetColorU32(ImGuiCol_Text, 0.9f));
}
