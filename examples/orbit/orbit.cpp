...
// Drag inside the window to orbit, shift-drag or middle-drag to pan,
// wheel to zoom; on a pad RT held with the right stick orbits, the
// left stick pans, the bumpers zoom. Tab (D-pad up) flies: W A S D and
// Q E move, the mouse or the right stick looks, Shift (L3) is faster,
// the wheel (D-pad) sets the speed, Esc (B) comes back. F1 (Back)
// rebinds any of it, and the bar lists what your device does.
//
