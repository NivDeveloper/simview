...
constexpr Icon kAll[] = {
    ...
    Icon::MouseRight,  Icon::MouseMiddle,  Icon::MouseWheel, Icon::PadA,
    Icon::PadB,        Icon::PadX,         Icon::PadY,       Icon::PadLB,
    Icon::PadRB,       Icon::PadLT,        Icon::PadRT,      Icon::PadLS,
    Icon::PadRS,       Icon::PadL3,        Icon::PadR3,      Icon::PadStart,
    Icon::PadBack,     Icon::Dpad,         Icon::DpadUp,     Icon::DpadDown,
    Icon::DpadLeft,    Icon::DpadRight};
